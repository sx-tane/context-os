...
applyTo: ".github/{agents,instructions,skills}/**/*.md"
---
...
- Skills live at `.github/skills/<name>/SKILL.md` and must keep `assets/` and `references/` subdirectories aligned with the procedure.
...
1. Update `.github/README.md` when agent, instruction, skill, routing, or folder structure behavior changes.
