...
- Document dataset paths, run commands, and baseline locations in the nearest identity or harness README.
...
- Nearest identity or harness README documents the dataset, command, and baseline used.
