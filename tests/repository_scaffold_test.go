...
func TestRepositoryScaffoldPathsExist(t *testing.T) {
	...
	requiredDirectories := []string{ // all directories that must exist for the scaffold to be valid
		...
		"internal/source",
		"internal/stages",
		"internal/stages/ingestion",
		"internal/stages/normalization",
		"internal/stages/classification",
		"internal/stages/extraction",
		"internal/stages/identity",
		"internal/stages/relationship",
		"internal/stages/graph",
		"internal/stages/reasoning",
		"internal/stages/execution",
		"internal/stages/presentation",
		"internal/runtime",
