...
| #32 Build Confluence MCP connector (deferred; no source scaffold)             | `type: feature`, `area: connectors`           |
...
| #11 Issue 8: Build Excel MCP connector (closed; folded into #12 filesystem)   | `type: feature`, `area: connectors`           |
| #10 Issue 7: Build OpenAPI MCP connector (closed; folded into #12 filesystem) | `type: feature`, `area: connectors`           |
