...
- The footer console strip shows service status, graph links, and finding count. Keep idle route state static so the main page does not re-render every second while no analysis or ingest is running.
