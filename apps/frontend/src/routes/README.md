...
- Activity receives a confirmation-gated cleanup callback from the route. The route calls `POST /artifacts/live-evidence/cleanup`, refreshes workspace Activity afterward, and never triggers cleanup automatically during normal refresh.
